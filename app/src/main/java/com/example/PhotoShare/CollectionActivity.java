    ...
    private void fetchLikedPhotos() {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(() ->
                        Toast.makeText(CollectionActivity.this, "网络错误: " + e.getMessage(), Toast.LENGTH_SHORT).show()
                );
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()) {
                    ...
                    Log.e("CollectedPhotosError", "Unsuccessful response: " + response.code() + " - " + responseBody);
                    runOnUiThread(() ->
                            Toast.makeText(CollectionActivity.this, "获取数据失败: " + response.message(), Toast.LENGTH_SHORT).show()
                    );
                } else {
                    ...
                    try {
                        ...
                        if (code == 200) {
                            ...
                            for (int i = 0; i < records.length(); i++) {
                                ...
                                Log.d("LikeNum", "likeNum: " + likeCount); // 打印 likeNum 值
                            ...
                            runOnUiThread(() ->
                                    Toast.makeText(CollectionActivity.this, "获取数据失败: " + message, Toast.LENGTH_SHORT).show()
                            );
                        }
                    } catch (Exception e) {
                        Log.e("LikedPhotosError", "Error parsing response", e);
                        runOnUiThread(() ->
                                Toast.makeText(CollectionActivity.this, "解析响应错误", Toast.LENGTH_SHORT).show()
                        );
                    }
                }
            }
